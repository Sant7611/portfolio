...
const Home = () => {
  ...
  <section id="home" className="scroll-mt-20 text-white flex flex-col-reverse md:flex-row w-full  justify-between gap-7  p-10 md:p-20">
      ...
      <div className="md:w-2/4 md:pt-10">
        ...
        <a href="#contact"block className="mt-5 no-underline md:m-10 text-white py-2 px-3 text-sm md:text-lg md:py-2 md:px-4 hover:opacity-85 duration-300 hover:scale-105 rounded-3xl bg-primary  ">
          Contact Me
        </a>
      </div>
