...
const ProjectCard = ({title, main, source}) => {
  return (
    <div className='p-3 md:p-6 mb-5 flex flex-col md:w-70 md:h-auto w-64 h-80   bg-[#01010100] shadow-xl shadow-[#3f3b3b] rounded-2xl ' >
        ...
        <div className="mt-2 p-2 md:p-4 flex gap-2 md:gap-4 w-full">
            <a href={source} className='md:mt-10 text-white py-2 px-3 text-sm md:text-lg md:py-2 md:px-4 hover:opacity-85 duration-300  hover:scale-105 font-semibold rounded-3xl bg-primary ' >Source Code</a>
        </div>
    </div>
  )
}
